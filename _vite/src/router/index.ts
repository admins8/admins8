  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'AdminBaiduPushPlugin',
        component: () => import('@/views/admin/BaiduPushPlugin.vue'),
        meta: { title: '百度主动推送', requiresAuth: true, requiresAdmin: true },
      },
      {
      ...
      },
      {
        ...
        meta: { title: 'APP管理', requiresAuth: true, requiresAdmin: true },
      },
      {
        path: 'system-update',
