...
export declare const getBaiduPushConfig: (req: Request, res: Response, next: any) => Promise<void>;
export declare const saveBaiduPushConfig: (req: Request, res: Response, next: any) => Promise<void>;
export declare const pushBaiduUrls: (req: Request, res: Response, next: any) => Promise<void>;
export declare const pushBaiduSitemap: (req: Request, res: Response, next: any) => Promise<void>;
export declare const getBaiduPushLogs: (req: Request, res: Response, next: any) => Promise<void>;
