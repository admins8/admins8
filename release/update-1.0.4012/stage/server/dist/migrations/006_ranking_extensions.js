...
exports.name = void 0;
exports.up = up;
exports.name = '006_ranking_extensions';
/**
...
async function up(db) {
    const columns = [
        {
            name: 'rank_type',
            ddl: "ADD COLUMN rank_type VARCHAR(32) NOT NULL DEFAULT 'popularity' COMMENT '榜单类型: popularity/new/review/chapter/complete/wordcount'",
        },
        {
            name: 'category',
            ddl: "ADD COLUMN category VARCHAR(64) NOT NULL DEFAULT '全部' COMMENT '榜单分类: 全部/玄幻/奇幻/武侠/仙侠/都市/历史/军事/游戏/体育/科幻/悬疑/同人/其他'",
        },
        {
            name: 'review_count',
...
//# sourceMappingURL=006_ranking_extensions.js.map