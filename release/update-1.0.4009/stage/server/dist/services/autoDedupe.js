...
exports.autoDedupeScheduler = void 0;
...
class AutoDedupeScheduler {
    ...
    async getInterval() {
        try {
            const row = await (0, database_1.queryOne)('SELECT config_value FROM site_config WHERE config_key = ?', [CONFIG_KEY]);
...
exports.autoDedupeScheduler = new AutoDedupeScheduler();
//# sourceMappingURL=autoDedupe.js.map