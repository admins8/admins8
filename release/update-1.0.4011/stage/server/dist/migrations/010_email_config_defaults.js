...
exports.name = void 0;
exports.up = up;
exports.name = '010_email_config_defaults';
const defaults = [
...
async function up(db) {
    for (const [key, value, description] of defaults) {
       ...
       VALUES (?, ?, ?)
       ON DUPLICATE KEY UPDATE description = VALUES(description)`, [key, value, description]);
    }
}
//# sourceMappingURL=010_email_config_defaults.js.map