...
exports.name = void 0;
exports.up = up;
exports.name = '008_book_category_column';
/**
...
async function up(db) {
    await ensureColumn(db, 'books', 'category', "ALTER TABLE books ADD COLUMN category VARCHAR(128) DEFAULT ''");
    await ensureIndex(db, 'books', 'idx_books_category', 'CREATE INDEX idx_books_category ON books (category)');
}
//# sourceMappingURL=008_book_category_column.js.map