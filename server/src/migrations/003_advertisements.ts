...
export const name = '003_advertisements';
...
export async function up(db: mysql.Pool): Promise<void> {
  await db.query(`
    CREATE TABLE IF NOT EXISTS advertisements (
      ...
      popup_interval_seconds INT NOT NULL DEFAULT ${DEFAULT_POPUP_INTERVAL_SECONDS} COMMENT '弹窗广告间隔秒数，仅 reader_popup 生效',
      popup_auto_close_seconds INT NOT NULL DEFAULT ${DEFAULT_POPUP_AUTO_CLOSE_SECONDS} COMMENT '弹窗广告自动关闭秒数，0 表示不自动关闭',
