    ...
    <div class="admin-layout">
      ...
      <aside class="admin-sidebar" :class="{ 'is-sidebar-open': mobileSidebarOpen }">
        ...
        >
          ...
          <el-sub-menu index="source-manage">
            <template #title>
          ...
          <el-sub-menu index="plugin-manage">
            <template #title>
              <el-icon><Operation /></el-icon>
              <span>插件管理</span>
            </template>
          ...
          <el-sub-menu v-if="isSuperAdmin" index="user-manage">
            <template #title>
          ...
          <el-menu-item v-if="isSuperAdmin" index="/admin/system-update">
            <el-icon><Refresh /></el-icon>
            <span>系统升级
              <el-badge v-if="hasUpdate" is-dot type="danger" style="margin-left: 6px" />
            </span>
          </el-menu-item>
          <el-menu-item v-if="isSuperAdmin" index="/admin/app-manage">
            <el-icon><Operation /></el-icon>
            <span>APP管理</span>
          </el-menu-item>
        </el-menu>
...
import { Setting, DataAnalysis, User, Reading, HomeFilled, Files, Picture, Document, Refresh, Message, Search, Link, Star, Calendar, Collection, Connection, Upload, CircleCheck, Operation } from '@element-plus/icons-vue'
