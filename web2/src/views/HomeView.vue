          ...
          <div class="result-info">
            <div class="result-header">
              ...
              <span class="exact-match-wrap">
                ...
                <span v-if="getExactMatchSourceBadgeCount(item)" class="source-count-badge">
                  {{ getExactMatchSourceBadgeCount(item) }}
                </span>
              </span>
...
import { getExactMatchSourceBadgeCount, useBookStore } from '@/store/book'
